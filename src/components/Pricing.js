            ...
            <section className="bg-white ">
                ...
                <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                    <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
                        <h2 className="mb-4 text-4xl tracking-tight font-bold  text-sky-900 ">Designed for the modern classroom</h2>
                        <p className="mb-5 font-light text-gray-500 sm:text-xl ">Focused on making AR</p>
                    </div>
