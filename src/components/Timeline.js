    ...
    <>
      <section id='roadmap'>
        ...
        <div class="bg-hero bg-pale p-5" id=''>
          ...
          <div class="border-2 absolute border-black md:h-full h-[80%] right-[49.89%] z-0" ></div>
            {/* <!-- left timeline --> */}
            <div class="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
              ...
              <div class="order-1 bg-red-400 rounded-lg shadow-xl w-full sm:w-5/12 px-6 py-4 z-10">
